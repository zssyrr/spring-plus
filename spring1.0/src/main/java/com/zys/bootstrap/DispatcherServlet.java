...
public class DispatcherServlet extends HttpServlet {
    ...
    private final Map<String, Method> urlMapping = new HashMap<>(16);
    ...
    private void doDispatch(HttpServletRequest req, HttpServletResponse resp) throws IOException, InvocationTargetException, IllegalAccessException {
        ...
        Object object = objectMapping.get(method.getDeclaringClass().getName());
        method.invoke(object, new Object[]{req, resp, "hello"});
                    ...
                    if (clazz.isAnnotationPresent(Service.class)) {
                        ...
                        for (Method declaredMethod : declaredMethods) {
                            ...
                            if (declaredMethod.isAnnotationPresent(RequestMapping.class)) {
                                ...
                                urlMapping.put(url + methodUrl, declaredMethod);
                            }
                        }
                    }
